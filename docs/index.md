...
You can use the [editor on GitHub](https://github.com/Kagayakashi/learn_rails/edit/main/docs/index.md) to maintain and
...
your [repository settings](https://github.com/Kagayakashi/learn_rails/settings). The name of this theme is saved in the
